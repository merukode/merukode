...
function Hero() {
  return (
    <div className='text-center h-3/4 p-3 flex flex-col justify-center items-center gap-4 md:flex-row md:justify-evenly md:w-9/12 md:m-auto '>
        ...
        <h1 className='font-extrabold text-4xl text-white md:text-5xl mb-4'>Hi, im <span className='md:hidden'>Rama</span> <span className='hidden md:block'>Aulia Ramadhan</span></h1>
        <p className='text-gray-200/50 mb-4'>Im a Front-End Web Developer with a passion for creating visually appealing and user-friendly websites.</p>
        <div>
        <Link href="/About">
